...
import {
  ArrowRight, Building2, CheckCircle2, Clock, HeadphonesIcon, MapPin,
...
export default function Home() {
  usePageMeta(
    ...
    'JM Logistics — Fast, reliable, and professional delivery solutions for individuals and businesses across Ghana.'
  )
                ...
                <AnimateInView key={row.title} variant="zoom" delay={i * 100}>
                  <div className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow h-full">
                    <div className="bg-orange-50 w-11 h-11 rounded-xl flex items-center justify-center mb-4">
                      {createElement(row.icon, { size: 20, className: 'text-orange-500' })}
                    </div>
